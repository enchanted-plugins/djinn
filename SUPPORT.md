...
| You have a… | Go to |
|-------------|-------|
| Security vulnerability | [Private security advisory](https://github.com/enchanted-plugins/djinn/security/advisories/new) — **never** a public issue. See [SECURITY.md](SECURITY.md). |
| Reproducible bug | [Bug report issue](https://github.com/enchanted-plugins/djinn/issues/new?template=bug_report.md). Include repro steps, versions, exact error. |
| Concrete feature proposal | [Feature request issue](https://github.com/enchanted-plugins/djinn/issues/new?template=feature_request.md). Half-formed ideas → Discussions first. |
| Usage question | [Discussions → Q&A](https://github.com/enchanted-plugins/djinn/discussions/categories/q-a) |
| Show-and-tell, idea, or discussion | [Discussions → Ideas / Show & Tell](https://github.com/enchanted-plugins/djinn/discussions) |
